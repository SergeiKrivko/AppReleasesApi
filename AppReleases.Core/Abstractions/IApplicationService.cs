...
public interface IApplicationService
{
    ...
    public Task<Application> CreateApplicationAsync(string key, string name, string description, string? mainBranch = null);
    public Task UpdateApplicationAsync(Guid applicationId, string name, string description, string mainBranch, TimeSpan? defaultDuration);
