...
public class BranchConfiguration : IEntityTypeConfiguration<BranchEntity>
{
    public void Configure(EntityTypeBuilder<BranchEntity> builder)
    {
        ...
        builder.Property(x => x.ReleaseLifetime).HasDefaultValue(null);
        builder.Property(x => x.LatestReleaseLifetime).HasDefaultValue(null);
        builder.Property(x => x.UseDefaultReleaseLifetime).HasDefaultValue(true).IsRequired();
